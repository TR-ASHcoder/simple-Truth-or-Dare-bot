...
client = commands.Bot(command_prefix='') # < -- add custom prefix here  
client.remove_command("help") 


# all questions VVVVVVV
tt = ["When was the last time you told a lie?",
...
"Could you live without having your devices for the rest of your life?",
...
"Tell us about something really crazy that you were able to get away with.","no question just cat  ᓚᘏᗢ"]

dd = ["Do a free-style rap for the next minute.",
...
dt = ["Do a free-style rap for the next minute.",
"Let another person post a status on your behalf.",
"Hand over your phone to another player who can send a single text saying anything they want to anyone they want.",
"Let the other players go through your phone for one minute.",
"Smell another player's armpit.",
...
@client.command(aliases = ['T','t','Truth','TRUTH'])
async def truth(ctx):
 em=discord.Embed(title= f"{random.choice(tt)}", 
 color=discord.Color.from_rgb(174,0,0)) 
 em.set_footer(text="Question type: TRUTH")
  
# em.set_thumbnail(url="")  < --- uncomment if you wanna add a image ig :/
  

 await ctx.reply(embed=em, mention_author = False)


@client.command(aliases = ['D','d','Dare','DARE'])
async def dare(ctx):
 em=discord.Embed(title= f"{random.choice(dd)}", 
 color=discord.Color.from_rgb(174,0,0)) 
 em.set_footer(text="Question type: DARE")
...
@client.command(aliases = ['R','r','Random','RANDOM','random'])
async def ran(ctx):
 em=discord.Embed(title= f"{random.choice(dt)}",
 color=discord.Color.from_rgb(174,0,0)) 
 em.set_footer(text="Question type: RANDOM")
...
@client.command()
async def help(ctx):
  em=discord.Embed(title= "*commands:*",  color=discord.Color.from_rgb(174,0,0)) 



  em.add_field(name="truth", value="gives you a truth question ", inline=False)
  
  em.add_field(name="dare", value="gives you a dare", inline=False)

  em.add_field(name="random", value="randomly picks from both categories", inline=False)
  
 

  em.set_footer(text="made by TR ASH#7081")
...
client.run('') # < --- add your token here nerd 
